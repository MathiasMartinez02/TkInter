...
img1 = ImageTk.PhotoImage(Image.open('images/tomioka.jpg'))
img2 = ImageTk.PhotoImage(Image.open('images/dobby.jpg'))
img3 = ImageTk.PhotoImage(Image.open('images/perrofachero.jpg'))
img4 = ImageTk.PhotoImage(Image.open('images/viejo.jpg'))
